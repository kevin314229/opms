...
CREATE TABLE `account` (
  ...
  `accountName` varchar(20) DEFAULT NULL COMMENT '帐号名',
  `password` varchar(100) DEFAULT NULL COMMENT '密码',
  `accountType` varchar(20) DEFAULT NULL COMMENT '帐号类型',
  `description` varchar(20) DEFAULT NULL COMMENT '说明',
  `state` varchar(3) DEFAULT NULL COMMENT '账号状态：0 表示停用 1表示启用',
  `createTime` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  `deletestatus` int(1) DEFAULT '0' COMMENT '逻辑删除状态0:存在1:删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='帐号表';

-- ----------------------------
-- Records of account
-- ----------------------------
INSERT INTO `account` VALUES ('1', 'root', 'Y6nw6nu5gFB5a2SehUgYRQ==', '0', '超级管理员', '1', '2015-04-23 19:48:56', '0');
...
INSERT INTO `account_role` VALUES ('34', '3');
...
CREATE TABLE `dic` (
  ...
  `dicTypeId` int(11) DEFAULT NULL COMMENT '字典类型ID',
  `dicKey` varchar(20) DEFAULT NULL COMMENT '字典KEY',
  `dicName` varchar(40) DEFAULT NULL COMMENT '字典名',
...
CREATE TABLE `dic_type` (
  ...
  `dicTypeKey` varchar(20) DEFAULT NULL COMMENT '字典类型KEY',
  `dicTypeName` varchar(40) DEFAULT NULL COMMENT '类型名',
  `description` varchar(200) DEFAULT NULL COMMENT '说明',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='字典类型';
...
CREATE TABLE `log` (
  ...
  `action` varchar(30) DEFAULT NULL COMMENT '行为',
  `actionTime` varchar(30) DEFAULT NULL COMMENT '行为发生时间',
...
INSERT INTO `log` VALUES ('2796', 'root', 'UserLoginServiceImpl', 'add', '80', '0:0:0:0:0:0:0:1', '2015-04-22 11:00:46');
INSERT INTO `log` VALUES ('2797', 'root', 'UserLoginServiceImpl', 'add', '6', '0:0:0:0:0:0:0:1', '2015-04-22 11:40:34');
INSERT INTO `log` VALUES ('2798', 'root', 'UserLoginServiceImpl', 'add', '3', '0:0:0:0:0:0:0:1', '2015-04-22 15:07:49');
INSERT INTO `log` VALUES ('2799', 'root', 'UserLoginServiceImpl', 'add', '4', '0:0:0:0:0:0:0:1', '2015-04-22 16:33:50');
INSERT INTO `log` VALUES ('2800', 'root', 'UserLoginServiceImpl', 'add', '19', '0:0:0:0:0:0:0:1', '2015-04-22 17:16:41');
INSERT INTO `log` VALUES ('2801', 'root', 'UserLoginServiceImpl', 'add', '3', '0:0:0:0:0:0:0:1', '2015-04-22 17:21:46');
INSERT INTO `log` VALUES ('2802', 'root', 'UserLoginServiceImpl', 'add', '4', '0:0:0:0:0:0:0:1', '2015-04-22 17:38:59');
INSERT INTO `log` VALUES ('2803', 'root', 'UserLoginServiceImpl', 'add', '5', '0:0:0:0:0:0:0:1', '2015-04-22 17:41:15');
INSERT INTO `log` VALUES ('2804', 'root', 'UserLoginServiceImpl', 'add', '3', '0:0:0:0:0:0:0:1', '2015-04-22 20:11:20');
INSERT INTO `log` VALUES ('2805', 'root', 'UserLoginServiceImpl', 'add', '3', '0:0:0:0:0:0:0:1', '2015-04-22 21:27:28');
INSERT INTO `log` VALUES ('2806', 'root', 'UserLoginServiceImpl', 'add', '3', '0:0:0:0:0:0:0:1', '2015-04-22 21:27:47');
INSERT INTO `log` VALUES ('2807', 'root', 'UserLoginServiceImpl', 'add', '2', '0:0:0:0:0:0:0:1', '2015-04-22 21:46:54');
INSERT INTO `log` VALUES ('2808', 'root', 'UserLoginServiceImpl', 'add', '38', '0:0:0:0:0:0:0:1', '2015-04-23 10:05:20');
INSERT INTO `log` VALUES ('2809', 'root', 'UserLoginServiceImpl', 'add', '2', '0:0:0:0:0:0:0:1', '2015-04-23 10:08:08');
INSERT INTO `log` VALUES ('2810', 'root', 'UserLoginServiceImpl', 'add', '2', '0:0:0:0:0:0:0:1', '2015-04-23 11:11:11');
INSERT INTO `log` VALUES ('2811', 'root', 'UserLoginServiceImpl', 'add', '2', '0:0:0:0:0:0:0:1', '2015-04-23 12:58:35');
INSERT INTO `log` VALUES ('2812', 'root', 'UserLoginServiceImpl', 'add', '8', '0:0:0:0:0:0:0:1', '2015-04-23 13:41:37');
INSERT INTO `log` VALUES ('2813', 'root', 'AccountServiceImpl', 'update', '6', '0:0:0:0:0:0:0:1', '2015-04-23 14:01:32');
INSERT INTO `log` VALUES ('2814', 'root', 'AccountServiceImpl', 'delete', '88', '0:0:0:0:0:0:0:1', '2015-04-23 14:02:31');
INSERT INTO `log` VALUES ('2815', 'root', 'AccountServiceImpl', 'update', '7', '0:0:0:0:0:0:0:1', '2015-04-23 14:04:33');
INSERT INTO `log` VALUES ('2816', 'test', 'UserLoginServiceImpl', 'add', '14', '0:0:0:0:0:0:0:1', '2015-04-23 14:06:29');
INSERT INTO `log` VALUES ('2817', 'root', 'UserLoginServiceImpl', 'add', '2', '0:0:0:0:0:0:0:1', '2015-04-23 14:07:17');
INSERT INTO `log` VALUES ('2818', 'root', 'UserLoginServiceImpl', 'add', '13', '0:0:0:0:0:0:0:1', '2015-04-23 14:38:17');
INSERT INTO `log` VALUES ('2819', 'root', 'UserLoginServiceImpl', 'add', '32', '0:0:0:0:0:0:0:1', '2015-04-23 15:50:41');
INSERT INTO `log` VALUES ('2820', 'root', 'UserLoginServiceImpl', 'add', '2', '0:0:0:0:0:0:0:1', '2015-04-23 16:05:01');
INSERT INTO `log` VALUES ('2821', 'root', 'UserLoginServiceImpl', 'add', '18', '0:0:0:0:0:0:0:1', '2015-04-23 16:05:01');
INSERT INTO `log` VALUES ('2822', 'root', 'RolesServiceImpl', 'addAccRole', '23', '0:0:0:0:0:0:0:1', '2015-04-23 16:31:40');
INSERT INTO `log` VALUES ('2823', 'root', 'UserLoginServiceImpl', 'add', '25', '0:0:0:0:0:0:0:1', '2015-04-23 16:39:24');
INSERT INTO `log` VALUES ('2824', 'root', 'UserLoginServiceImpl', 'add', '27', '0:0:0:0:0:0:0:1', '2015-04-23 17:34:29');
INSERT INTO `log` VALUES ('2825', 'root', 'UserLoginServiceImpl', 'add', '7', '0:0:0:0:0:0:0:1', '2015-04-23 18:35:42');
INSERT INTO `log` VALUES ('2826', 'root', 'UserLoginServiceImpl', 'add', '8', '0:0:0:0:0:0:0:1', '2015-04-23 20:06:25');
INSERT INTO `log` VALUES ('2827', 'root', 'RolesServiceImpl', 'addAccRole', '2', '0:0:0:0:0:0:0:1', '2015-04-23 20:06:50');
INSERT INTO `log` VALUES ('2828', 'root', 'ResourcesServiceImpl', 'addRoleRes', '10', '0:0:0:0:0:0:0:1', '2015-04-23 20:08:24');
INSERT INTO `log` VALUES ('2829', 'test', 'UserLoginServiceImpl', 'add', '2', '0:0:0:0:0:0:0:1', '2015-04-23 20:08:44');
INSERT INTO `log` VALUES ('2830', 'root', 'UserLoginServiceImpl', 'add', '8', '0:0:0:0:0:0:0:1', '2015-04-23 20:55:00');
INSERT INTO `log` VALUES ('2831', 'root', 'UserLoginServiceImpl', 'add', '5', '0:0:0:0:0:0:0:1', '2015-04-24 10:32:45');
INSERT INTO `log` VALUES ('2832', 'root', 'UserLoginServiceImpl', 'add', '3', '0:0:0:0:0:0:0:1', '2015-04-24 14:38:05');
INSERT INTO `log` VALUES ('2833', 'root', 'UserLoginServiceImpl', 'add', '22', '0:0:0:0:0:0:0:1', '2015-04-24 17:34:04');
INSERT INTO `log` VALUES ('2834', 'root', 'UserLoginServiceImpl', 'add', '15', '0:0:0:0:0:0:0:1', '2015-04-24 17:48:21');
INSERT INTO `log` VALUES ('2835', 'root', 'UserLoginServiceImpl', 'add', '21', '0:0:0:0:0:0:0:1', '2015-04-24 18:48:41');
INSERT INTO `log` VALUES ('2836', 'root', 'UserLoginServiceImpl', 'add', '68', '0:0:0:0:0:0:0:1', '2015-04-25 09:30:14');
INSERT INTO `log` VALUES ('2837', 'root', 'UserLoginServiceImpl', 'add', '2', '0:0:0:0:0:0:0:1', '2015-04-25 10:57:01');
INSERT INTO `log` VALUES ('2838', 'root', 'UserLoginServiceImpl', 'add', '3', '0:0:0:0:0:0:0:1', '2015-04-25 12:26:24');
...
CREATE TABLE `res_roles` (
  `role_id` int(11) NOT NULL DEFAULT '0' COMMENT '角色ID',
  `resc_id` int(11) NOT NULL DEFAULT '0' COMMENT '访问资源ID',
  PRIMARY KEY (`resc_id`,`role_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='角色可访问的资源表';
...
INSERT INTO `res_roles` VALUES ('3', '31');
INSERT INTO `res_roles` VALUES ('1', '32');
INSERT INTO `res_roles` VALUES ('3', '32');
INSERT INTO `res_roles` VALUES ('1', '33');
INSERT INTO `res_roles` VALUES ('3', '33');
INSERT INTO `res_roles` VALUES ('1', '34');
INSERT INTO `res_roles` VALUES ('3', '34');
...
CREATE TABLE `role` (
  ...
  `enable` int(10) DEFAULT NULL COMMENT '是否禁用角色：1表示禁用，2表示不禁用',
...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES ('1', '1', '超级管理员', 'root', '拥有所有权限');
INSERT INTO `role` VALUES ('2', '1', '管理员', 'admin', '管理系统权限');
INSERT INTO `role` VALUES ('3', '1', '一般用户', 'simple', '普通角色');
...
CREATE TABLE `server_info` (
  ...
  `setJvmUsage` varchar(255) DEFAULT NULL COMMENT '预设Jvm使用率',
  `ramUsage` varchar(255) DEFAULT NULL COMMENT '当前使用Ram使用率',
  `setRamUsage` varchar(255) DEFAULT NULL COMMENT '预设Ram使用率',
  `email` varchar(255) DEFAULT NULL COMMENT '发送的邮件',
