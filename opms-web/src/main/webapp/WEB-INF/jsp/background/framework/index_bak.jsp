	...
	$(function() {
		...
		$.ajax({
					...
					url : '${ctx}/background/resources/resources.html?id='
							+ <%=request.getSession().getAttribute("userSessionId").toString()%>,
					dataType : 'json',
...
<body onresize="divsize();">
	...
	<div id="index_body">
		...
		<div id="myHomePage" style="display: none;">
			<div class="cl_body" style="background: none repeat scroll 0 0 #FAFAFA; overflow: auto;">
				<div id="divHeght">
					<div class="leftTree">
