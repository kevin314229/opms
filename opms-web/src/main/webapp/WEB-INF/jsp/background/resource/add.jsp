...
<script type="text/javascript">
	...
	$("form").validate({
		...
		name : {
		    ...
		    remote : { //异步验证是否存在
			type : "POST",
			url : rootPath + '/background/resource/isExist.html',
			data : {
			    name : function() {
				return $("#name").val();
			    }
...
<body>
	<div class="divdialog">
		...
		<form name="form" id="form" action="${ctx}/background/resource/add.html" method="post">
			<table style="width: 285px; height: 230px;">
				<tbody>
					...
					<tr>
						...
						<td class="l_left">
							<div class="opms_input">
								<input id='resUrl' name="resUrl" type="text" class="checkdesc">
							</div>
						</td>
					</tr>
					<tr>
